/**
 * UI Kit'in tek noktadan tema erişimi.
 * Ekranlar `from '../ui'` ile component'leri çekerken, kit içi component'lar
 * da bu dosya üstünden palet/tipografi/token'lara ulaşır.
 */
 ...
 * "Bold Productivity" vibe için her tone'un kendi pastel arkaplanı ve canlı
 * koyu metin/border rengi var.
 */
export const tones = {
  surface: {
  ...
  // "Dark Executive" — koyu yuzeyli metrik / hero kart tone'u
  executive: {
  ...
  // Koyu accent (turuncu) yuzey - "yapilmasi gereken aksiyon" CTA kartlari
  executiveAccent: {
