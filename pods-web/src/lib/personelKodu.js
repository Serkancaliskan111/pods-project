/** Personel kodu — normalize, müsaitlik ve öneri */
...
/** Aktif (silinmemiş) personeller arasında kod dolu mu? */
...
/**
 * P-0001, P-0002 … formatında sıradaki boş kodu önerir.
 * @param {{ prefix?: string, companyId?: string|null }} opts
 */
