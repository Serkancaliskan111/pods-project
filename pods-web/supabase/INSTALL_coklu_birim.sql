-- =============================================================================
-- ÇOKLU BİRİM — TEK SEFERDE KURULUM (Supabase SQL Editor: dosyanın tamamını çalıştır)
--
-- • personel_birimleri junction tablosu + tetikleyiciler + RLS
-- • personeller.birim_id birincil birim ile senkron
-- • Birim silme guard: personeller_birim_agaci_icinde_sayisi junction dahil
--
-- Önkoşul: public.personeller, public.birimler, public.ana_sirketler mevcut olmalı.
-- =============================================================================
...
comment on table public.personel_birimleri is
  'Personele bağlı bir veya daha fazla kök birim; erişim kapsamı alt ağaç birleşimi ile genişler.';
