-- Önceki sürüm 023 yalnızca sıra değiştiriyordu; personel ekleme için bu dosyayı çalıştırın (023 ile aynı fonksiyon gövdesi).
-- İlk kurulumda yalnızca 023 yeterlidir.
