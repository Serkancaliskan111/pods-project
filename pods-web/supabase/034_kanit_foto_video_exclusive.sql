-- 034: Foto veya video kanıtı — ikisi aynı anda zorunlu olamaz (032 öncesi ortamlar için).
BEGIN;

UPDATE public.isler SET video_zorunlu = false, min_video_sayisi = 0 WHERE foto_zorunlu AND video_zorunlu;
UPDATE public.is_sablonlari SET video_zorunlu = false, min_video_sayisi = 0 WHERE foto_zorunlu AND video_zorunlu;
